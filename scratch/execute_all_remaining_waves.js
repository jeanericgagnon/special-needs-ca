...
const remainingWaves = [
  {
    waveNum: 2,
    states: ['new-jersey', 'wyoming', 'maryland', 'utah', 'new-mexico', 'oregon', 'washington', 'idaho']
  },
  {
    waveNum: 3,
    states: ['south-carolina', 'north-dakota', 'west-virginia', 'montana', 'colorado', 'louisiana', 'south-dakota', 'alabama', 'wisconsin', 'arkansas', 'oklahoma']
  },
  {
    waveNum: 4,
    states: ['north-carolina', 'mississippi', 'michigan', 'minnesota']
  },
  {
    waveNum: 5,
    states: ['indiana', 'nebraska', 'tennessee', 'virginia']
  },
  {
    waveNum: 6,
    states: ['iowa', 'kansas', 'missouri', 'kentucky']
  }
];

const db = new Database(dbPath);

console.log(`🚀 STARTING AUTONOMOUS ROLLOUT FOR ALL REMAINING WAVES (31 STATES)`);

for (const wave of remainingWaves) {
  console.log(`\n====================================================`);
  console.log(`🌊 WAVE ${wave.waveNum} STARTING: ${wave.states.join(', ').toUpperCase()}`);
  console.log(`====================================================`);
...
db.close();
console.log(`\n🎉 ALL REMAINING WAVES ROLLOUT COMPLETED SUCCESSFULLY!`);
