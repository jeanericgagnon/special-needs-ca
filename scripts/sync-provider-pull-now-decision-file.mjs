...
const templatePath = path.join(docsDir, `provider-pull-now-decision-template-${generatedDate}.json`);
const activePath = path.join(dataDir, 'provider-pull-now-decisions.json');
