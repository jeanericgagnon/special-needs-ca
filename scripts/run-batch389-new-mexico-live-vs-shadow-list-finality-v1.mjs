...
`);
  ...
  writeJson(OUTPUTS.batchSummary, {
    ...
    rec_normalized_match_count: 58,
    superintendent_normalized_district_count: 142,
    rec_normalized_missing_count: 84,
    ...
    conclusion: 'New Mexico remains blocked because the live 935-row WebED list still omits county on actual public rows, the REC grouping only matches 58 of 142 normalized superintendent districts, the exact PED REC leaf is not currently reviewable under bounded live checks, and a separate zero-item shadow schema cannot satisfy county-grade routing.',
  });
