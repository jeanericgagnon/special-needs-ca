...
function main() {
  ...
  const updatedVerifiedRows = verifiedRows.map((row) => {
    ...
    return {
      ...
      sample_count: 14,
      query_basis: 'Reviewed 2026-06-25 the live DES public Salesforce locator app, its first-party `EOLSalesforceScript.js` bundle, the recovered official DDS remoting contract `srchParms = {srchradmiles, ctrlat, ctrlng, schsvccode}`, the live Greenlee-area DDS replay results, the official Greenlee County useful-links page, the official Greenlee County `Health & County Services` page, the Morenci public health-directory page, and first-party Clifton, Duncan, and Morenci town surfaces to tighten Arizona county-local routing from a statewide blocker to a single Greenlee county-level contract question.',
      ...
      samples: [
        ...
        {
          sample_name: 'Greenlee County Health & County Services page',
          source_url: 'https://greenlee.az.gov/ova_dep/health-and-county-services/',
          final_url: 'https://greenlee.az.gov/ova_dep/health-and-county-services/',
          verification_status: 'reviewed',
          source_type: 'official_county_health_services_page_without_des_assignment',
          source_table: BATCH,
          fetched_at: '2026-06-25T00:00:00.000Z',
          evidence_snippet: 'The official Greenlee County Health & County Services page is live and routes to county public-health and government-health-link surfaces, but it still does not name any DES or AHCCCS office assignment for Greenlee County.',
        },
        {
        ...
        {
          sample_name: 'Morenci health directory page',
          source_url: 'https://www.morencitown.com/directories#health',
          final_url: 'https://www.morencitown.com/directories#health',
          verification_status: 'reviewed',
          source_type: 'first_party_town_health_directory_without_des_assignment',
          source_table: BATCH,
          fetched_at: '2026-06-26T00:00:00.000Z',
          evidence_snippet: 'The live Morenci health directory links Greenlee County health and Gila Health care pages, but it still does not name any DES or AHCCCS county-to-office assignment for Greenlee County.',
        },
        {
        ...
        {
          sample_name: 'AHCCCS ALTCS county map stale shell',
          source_url: 'https://www.azahcccs.gov/Members/Downloads/ALTCS_CountyMap.pdf',
          final_url: 'https://www.azahcccs.gov/Members/Downloads/ALTCS_CountyMap.pdf',
          verification_status: 'reviewed',
          source_type: 'stale_official_fallback_document_shell',
          source_table: BATCH,
          fetched_at: '2026-06-25T00:00:00.000Z',
          evidence_snippet: 'The old ALTCS county-map URL now returns a 200 HTML `Document not found` shell instead of a usable PDF or county-routing artifact.',
        },
        {
          sample_name: 'AHCCCS contacts stale shell',
          source_url: 'https://www.azahcccs.gov/AHCCCS/Downloads/AHCCCScontacts.html',
          final_url: 'https://www.azahcccs.gov/AHCCCS/Downloads/AHCCCScontacts.html',
          verification_status: 'reviewed',
          source_type: 'stale_official_fallback_document_shell',
          source_table: BATCH,
          fetched_at: '2026-06-25T00:00:00.000Z',
          evidence_snippet: 'The old AHCCCS contacts URL now returns a 200 HTML `Document not found` shell instead of a usable contact-routing artifact.',
        },
      ],
    };
  });
