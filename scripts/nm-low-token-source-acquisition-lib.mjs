...
const REGISTRY_SEEDS = [
  {
    ...
    official_domains: ['nmhealth.org'],
    authority: 'official_state',
    domain_evidence_url: 'https://www.nmhealth.org/about/ddsd',
    evidence_title: 'New Mexico Developmental Disabilities Supports Division',
    notes: 'Backed by existing DB provenance and unresolved-role hints.',
  },
  {
    agency: 'New Mexico Human Services Department / Medicaid',
    program_family: 'medicaid_hsd_hca',
    official_domains: ['hsd.state.nm.us'],
    authority: 'official_state',
    domain_evidence_url: 'https://www.hsd.state.nm.us/mad',
    evidence_title: 'New Mexico Medicaid / MAD',
    notes: 'Backed by existing DB provenance and unresolved-role hints.',
  },
  {
  ...
  },
  {
    ...
    domain_evidence_url: '',
    evidence_title: '',
    notes: 'No reviewed New Mexico P&A domain found in current repo/DB artifacts; keep unresolved until reviewed.',
  },
  {
    agency: 'Legal Aid',
    ...
    domain_evidence_url: '',
    evidence_title: '',
    notes: 'No reviewed New Mexico legal-aid domain found in current repo/DB artifacts; keep unresolved until reviewed.',
  },
  {
    agency: 'State or county directory roots',
    program_family: 'local_office_directories',
    official_domains: ['nmhealth.org', 'hsd.state.nm.us', 'webnew.ped.state.nm.us'],
    authority: 'official_state',
    domain_evidence_url: 'https://www.nmhealth.org/about/ddsd',
    evidence_title: 'New Mexico directory root hints',
    notes: 'Used only for role-specific official directory discovery.',
  },
];

const ROLE_DEFINITIONS = [
  role('main_dd_agency', 'dd_routing', 'dd_system', 'critical', 'New Mexico Health Care Authority', ['nmhealth.org'], ['developmental', 'disabilities'], ['supports', 'division', 'agency', 'services'], ['medicaid', 'early intervention', 'school complaint'], ['html'], 'State DD agency entry point.'),
  role('dd_eligibility', 'dd_routing', 'dd_system', 'critical', 'New Mexico Health Care Authority', ['nmhealth.org'], ['eligibility'], ['developmental', 'disabilities'], ['medicaid', 'school complaint'], ['html', 'pdf'], 'DD eligibility page.'),
  role('dd_intake_application', 'dd_routing', 'dd_system', 'critical', 'New Mexico Health Care Authority', ['nmhealth.org'], ['apply'], ['intake', 'application', 'services'], ['medicaid', 'school complaint'], ['html', 'pdf', 'portal'], 'DD intake/application path.'),
  role('dd_local_regional_office_directory', 'dd_routing', 'dd_system', 'critical', 'New Mexico Health Care Authority', ['nmhealth.org'], ['office'], ['directory', 'regional', 'contact', 'locations'], ['employment', 'tax'], ['html'], 'DD local or regional office directory.'),
  role('dd_waiver_programs', 'programs_benefits', 'dd_system', 'critical', 'New Mexico Health Care Authority', ['nmhealth.org'], ['waiver'], ['hcbs', 'developmental', 'disabilities'], ['school complaint'], ['html', 'pdf'], 'DD waiver/program entry page.'),
  role('dd_appeals_complaints', 'programs_benefits', 'dd_system', 'critical', 'New Mexico Health Care Authority', ['nmhealth.org'], ['appeal'], ['complaint', 'hearing', 'grievance'], ['special education'], ['html', 'pdf'], 'DD appeals or complaints path.'),
  role('medicaid_application', 'programs_benefits', 'medicaid_and_waivers', 'critical', 'New Mexico Human Services Department / Medicaid', ['hsd.state.nm.us'], ['medicaid', 'mad'], ['apply', 'application', 'benefits'], ['employment', 'provider enrollment'], ['html', 'portal', 'pdf'], 'Medicaid application path.'),
  role('medicaid_eligibility', 'programs_benefits', 'medicaid_and_waivers', 'critical', 'New Mexico Human Services Department / Medicaid', ['hsd.state.nm.us'], ['medicaid', 'mad'], ['eligibility', 'qualify'], ['employment'], ['html', 'pdf'], 'Medicaid eligibility page.'),
  role('personal_care_attendant_care', 'programs_benefits', 'medicaid_and_waivers', 'critical', 'New Mexico Human Services Department / Medicaid', ['hsd.state.nm.us'], ['care'], ['personal', 'attendant', 'pcs'], ['employment'], ['html', 'pdf'], 'Personal care / attendant care page.'),
  role('hcbs_waivers', 'waivers', 'medicaid_and_waivers', 'critical', 'New Mexico Human Services Department / Medicaid', ['nmhealth.org', 'hsd.state.nm.us'], ['waiver'], ['hcbs', 'home and community'], ['special education'], ['html', 'pdf'], 'HCBS waiver entry page.'),
  role('medicaid_grievances_appeals', 'programs_benefits', 'medicaid_and_waivers', 'critical', 'New Mexico Human Services Department / Medicaid', ['hsd.state.nm.us'], ['medicaid', 'mad'], ['appeal', 'grievance'], ['special education'], ['html', 'pdf'], 'Medicaid appeals or grievances page.'),
  role('medicaid_fair_hearing', 'programs_benefits', 'medicaid_and_waivers', 'critical', 'New Mexico Human Services Department / Medicaid', ['hsd.state.nm.us'], ['hearing'], ['fair hearing', 'hearing request'], ['special education'], ['html', 'pdf', 'portal'], 'Medicaid fair-hearing path.'),
  role('medicaid_renewals_redeterminations', 'programs_benefits', 'medicaid_and_waivers', 'critical', 'New Mexico Human Services Department / Medicaid', ['hsd.state.nm.us'], ['renew'], ['redetermination', 'recertification'], ['provider'], ['html', 'pdf', 'portal'], 'Medicaid renewals/redeterminations.'),
  role('ei_part_c_program', 'programs_benefits', 'early_intervention', 'critical', 'Early intervention / Part C', [], ['early intervention'], ['part c', 'family infant toddler'], ['medicaid'], ['html', 'pdf'], 'Part C program page.'),
  role('ei_referral_intake', 'programs_benefits', 'early_intervention', 'critical', 'Early intervention / Part C', [], ['early intervention'], ['referral', 'intake', 'refer'], ['medicaid'], ['html', 'pdf', 'portal'], 'EI referral/intake.'),
  role('ei_eligibility', 'programs_benefits', 'early_intervention', 'critical', 'Early intervention / Part C', [], ['early intervention'], ['eligibility', 'eligible'], ['medicaid'], ['html', 'pdf'], 'EI eligibility.'),
  role('ei_local_office_directory', 'education_routing', 'early_intervention', 'critical', 'Early intervention / Part C', [], ['early intervention'], ['office', 'directory', 'contact'], ['employment'], ['html'], 'EI local office directory.'),
  role('ei_family_rights', 'education_routing', 'early_intervention', 'critical', 'Early intervention / Part C', [], ['early intervention'], ['family rights', 'parent rights', 'procedural safeguards'], ['medicaid'], ['html', 'pdf'], 'EI family rights page.'),
  role('ei_complaints_mediation_due_process', 'education_routing', 'early_intervention', 'critical', 'Early intervention / Part C', [], ['early intervention'], ['complaint', 'mediation', 'due process'], ['medicaid'], ['html', 'pdf'], 'EI disputes page.'),
  ...
  role('protection_advocacy_resources', 'advocates_legal', 'local_resource_directories', 'high', 'Protection and Advocacy', [], ['disability'], ['rights', 'advocacy'], ['medicaid'], ['html'], 'Protection and advocacy resource.'),
  role('legal_aid_resources', 'advocates_legal', 'local_resource_directories', 'high', 'Legal Aid', [], ['legal'], ['aid', 'services', 'help'], ['state bar directory'], ['html'], 'Legal aid resource.'),
...
function mergeRegistryWithHints(repoRoot, dbPath) {
  ...
  return REGISTRY_SEEDS.map((seed) => ({
    ...
    official_domains: stableUnique(seed.official_domains.map(normalizeDomain)).filter((domain) => !domain || hintedDomains.has(domain) || domain === 'ssa.gov' || domain === 'ablenrc.org' || domain === 'parentcenterhub.org'),
...
function inferAuthorityForRole(roleRow) {
  ...
  if (roleRow.allowed_domains.includes('parentcenterhub.org') || roleRow.allowed_domains.includes('ablenrc.org')) return 'high_authority_nonprofit';
