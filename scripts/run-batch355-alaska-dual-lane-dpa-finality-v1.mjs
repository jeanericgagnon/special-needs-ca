...
export async function generateBatch355AlaskaDualLaneDpaFinalityV1() {
  ...
  for (const row of verifiedRows) {
    ...
    replaceSample(row.samples, 'Alaska DFCS public search page', {
      ...
      verification_status: 'reviewed',
      source_type: 'official_public_search_with_generic_navigation_only',
      source_table: BATCH_NAME,
      fetched_at: PROBE.generatedAt,
      evidence_snippet: 'The live public DFCS search page loads at `/pages/search.aspx`, but bounded `public assistance`, `office`, `medicaid`, `adult public assistance`, and `virtual contact center` queries only materialize generic site-navigation results such as Home, Divisions, Commissioner\'s Office, Alaska Pioneer Homes, Alaska Psychiatric Institute, Finance & Management Services, Juvenile Justice, and Office of Children\'s Services, with no role-bearing DPA, public-assistance office, or borough-assignment results.',
    });
