...
assert.equal(summary.primary_gap_reason, 'reviewed_idaho_district_leaves_hold_at_13_counties_after_live_bear_lake_special_education_leaf_and_remaining_county_bearing_district_roots_still_lack_role_evidence');
...
assert.equal(educationFailure.failure_code, 'reviewed_district_special_services_leaves_hold_at_13_counties_after_live_bear_lake_leaf_and_remaining_county_bearing_roots_still_lack_role_leaf');
...
assert.equal(verified.sample_count, 15);
...
assert.equal(queueRow.primary_gap_reason, 'reviewed_idaho_district_leaves_hold_at_13_counties_after_live_bear_lake_special_education_leaf_and_remaining_county_bearing_district_roots_still_lack_role_evidence');
...
assert.equal(allStateRow.packetPrimaryGapReason, 'reviewed_idaho_district_leaves_hold_at_13_counties_after_live_bear_lake_special_education_leaf_and_remaining_county_bearing_district_roots_still_lack_role_evidence');
...
assert.match(allStateReport, /Idaho remains blocked, but the education lane improved/i);
assert.ok(handoff.includes('## Current Focus State: Idaho'));
assert.ok(handoff.includes('reviewed_idaho_district_leaves_hold_at_13_counties_after_live_bear_lake_special_education_leaf_and_remaining_county_bearing_district_roots_still_lack_role_evidence'));
