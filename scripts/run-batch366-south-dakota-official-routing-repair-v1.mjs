        ...
        samples: [
          {
            ...
            evidence_snippet: 'The public South Dakota Educational Directory lists statewide Public School Districts and links each district to a detail page.',
          },
          {
          ...
          },
          {
            ...
            source_table: 'school_districts',
            evidence_snippet: 'The official district-maps page publishes district and county map PDFs on the same DOE directory family, reinforcing public local-routing support.',
          },
        ],
      };
    }
