...
const seedNeeds = [
  ...
  { id: 'occupational-therapy', name: 'Occupational Therapy', category: 'daily-living', description: 'Needs help with fine motor skills, sensory regulation, dressing, feeding, or other daily living tasks.', program_triggers: 'early-start,iep-special-education,regional-centers,california-childrens-services' },
  { id: 'physical-therapy', name: 'Physical Therapy', category: 'mobility', description: 'Needs support with walking, balance, transfers, posture, endurance, or gross motor development.', program_triggers: 'early-start,iep-special-education,california-childrens-services,regional-centers' },
  { id: 'behavior-support', name: 'Behavior Support', category: 'behavioral', description: 'Needs behavioral assessment, parent coaching, crisis prevention, or intensive behavior intervention.', program_triggers: 'regional-centers,iep-special-education,early-start' },
  ...
  { id: 'feeding-therapy', name: 'Feeding Therapy', category: 'medical', description: 'Needs help with chewing, swallowing, oral motor skills, or severe feeding selectivity.', program_triggers: 'early-start,california-childrens-services,medi-cal-for-kids-and-teens' },
  { id: 'mobility-equipment', name: 'Mobility Equipment', category: 'mobility', description: 'Needs a wheelchair, walker, stander, gait trainer, orthotics, or other mobility-support equipment.', program_triggers: 'california-childrens-services,medi-cal-for-kids-and-teens,hcba' },
  { id: 'assistive-technology', name: 'Assistive Technology', category: 'communication', description: 'Needs adapted communication, access, learning, or sensory equipment to participate at home or school.', program_triggers: 'iep-special-education,regional-centers,california-childrens-services' },
  { id: 'transportation-support', name: 'Transportation Support', category: 'daily-living', description: 'Needs transportation help to reach school, therapies, medical visits, or community-based services.', program_triggers: 'iep-special-education,regional-centers,medi-cal-for-kids-and-teens' },
  { id: 'nursing-care', name: 'Skilled Nursing Care', category: 'medical', description: 'Needs private duty nursing, shift nursing, or complex medical oversight at home.', program_triggers: 'hcba,medi-cal-for-kids-and-teens' },
  ...
  { id: 'school-accommodations', name: 'School Accommodations & Classroom Supports', category: 'education', description: 'Needs accommodations, related services, classroom supports, or behavior/sensory planning in school.', program_triggers: 'iep-special-education' },
  { id: 'transition-planning', name: 'Transition Planning', category: 'planning', description: 'Needs age-14+ planning for adulthood, services transition, postsecondary goals, or legal changes at 18.', program_triggers: 'iep-special-education,regional-centers,calable,ssi-for-children' },
  { id: 'caregiver-support', name: 'Caregiver Support & Parent Training', category: 'planning', description: 'Needs coaching, parent education, peer support, or system-navigation help for the caregiver.', program_triggers: 'regional-centers,early-start,iep-special-education' }
];
