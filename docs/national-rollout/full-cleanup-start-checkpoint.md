# Full Canonical Cleanup Start Checkpoint

**Date:** June 15, 2026  
**Timestamp:** 1781533251456  
**Root Database Backup:** `/Users/ericgagnon/Documents/antigravity/beautiful-lavoisier/backups/ca_disability_navigator.db.backup-cleanup-1781533251456`  
**Frontend Database Backup:** `/Users/ericgagnon/Documents/antigravity/beautiful-lavoisier/backups/frontend-ca_disability_navigator.db.backup-cleanup-1781533251456`  
...
* **Docs Directory (`docs/**/*.md`):** 1194
* **Data Directory (`data/**/*.json`):** 298
* **Root Database (`ca_disability_navigator.db`):** 440
* **Frontend Database (`frontend/ca_disability_navigator.db`):** 440
