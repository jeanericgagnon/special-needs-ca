# National Manual Review Operating System (V3)

**Date:** June 14, 2026  
**Auditor:** Antigravity (AI Coding Assistant)  
**Total Backlog Backlog:** **6,091 records**  

---

## 1. Backlog & Priority Overview

Our data audit shows a national backlog of **6,091 records** requiring manual verification to replace generated county scaffolds with real source-supported contact details.

| Curation Queue | Table Name | Verification Backlog | Priority | Curation Target |
| :--- | :--- | :---: | :---: | :--- |
| **School Districts SPED** | `school_districts` | **2,696** | High | Replace fallback district contacts with official SPED directors. |
| **HHS/Medicaid storefronts** | `county_offices` | **2,350** | High | Verify direct phone lines and intake offices. |
| **Special Education Advocates**| `iep_advocates` | **928** | Medium | Verify names, phones, and email listings. |
| **State Resource Agencies** | `state_resource_agencies`| **80** | Medium | Verify regional DBHDD, APD, and EI regional offices. |
| **Regional Education Agencies**| `regional_education_agencies`| **37** | Medium | Verify ESC, BOCES, and RESA contacts. |

---

## 2. Structured Curation Queues (V3)
...
2. **School District SPED Queue:** Resolves the 2,696 unverified districts.
