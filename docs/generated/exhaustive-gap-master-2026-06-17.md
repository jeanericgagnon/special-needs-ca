...
- Modeled info-complete states on the current audit bar: 50/50
- High-confidence states on the current audit bar: 50/50
- Strict-gold states on the truth registry: 49/50
- Public-safe but still blocked states: 1/50
- Bottom line: The repo is broadly complete on its current modeled 50-state public-truth bar, but it is not yet exhaustive across all information types the product model implies.
...
- Advocates: 2995
- Organizations: 36891
- Organization-program links: 36891
- Service locations: 83
...
| Local providers, clinics, therapists, and care | thin | critical_gap | 83 public provider rows and 23 staged provider rows across all 50 states. | This is the biggest information hole if the goal is all local help, especially to compete on care and treatment discovery. |
| Nonprofit coverage quality and local utility | broad | broad_but_not_exhaustive | 29499 nonprofit rows across 50 states. | Coverage is broad, but accessibility, capacity, and local in-person truth signals are still sparse. |
...
| Findhelp-like metadata: availability, accessibility, intake, capacity | modeled | partial | Provider accessibility booleans with true signal: accepts_medi_cal 27/83; interpreter_available 22/83; asl_available 12/83; wheelchair_accessible 5/83; virtual_services 18/83; in_person_services 60/83; home_visits 3/83; transportation_help 8/83 Nonprofit accessibility booleans with true signal: interpreter_available 0/29499; asl_available 0/29499; wheelchair_accessible 0/29499; virtual_services 1/29499; in_person_services 22/29499; home_visits 0/29499; transportation_help 0/29499 Advocate accessibility booleans with true signal: interpreter_available 0/2995; asl_available 0/2995; wheelchair_accessible 0/2995; virtual_services 2/2995; in_person_services 0/2995; home_visits 0/2995; transportation_help 0/2995 | The schema exists, but live high-signal metadata is sparse, especially on nonprofits and advocates. |
| Canonical org -> program -> location normalization | present | partial | 36891 organizations, 36891 org-program links, 83 service locations, 4314 office locations, 33130 virtual service areas. | Normalization exists, but service-location depth is still too thin to support a fully location-rich help product. |
| Conditions, functional needs, age bands, insurance types | mixed | partial | 78 conditions, 18 functional needs, 0 age bands, 0 insurance types. | Conditions and needs are strong, but age-band and insurance reference tables are still empty. |
| Help content and explanatory knowledge | thin | critical_gap | 15 knowledge articles. | The content layer is far too small for a product that aims to cover the full family journey nationally. |
...
- Current audit status: substantial
- Exhaustive interpretation: broad_but_not_exhaustive
- Evidence: 29499 nonprofit listings across 50/50 states
...
- Current audit status: partial
- Exhaustive interpretation: partial
- Evidence: 83 provider listings across 50/50 states
- Evidence: 23 staged provider rows waiting in provider staging
...
- Evidence: Those fields sit on 32577 directory rows total.
...
- Current audit status: thin
- Exhaustive interpretation: thin
- Evidence: 36891 organizations
- Evidence: 36891 organization-program links
- Evidence: 83 service locations
...
- Current audit status: partial
- Exhaustive interpretation: partial
- Evidence: 15 knowledge articles
...
- California remains the only strict-gold exception right now because advocate truth gating still drops coverage in 58 counties.
