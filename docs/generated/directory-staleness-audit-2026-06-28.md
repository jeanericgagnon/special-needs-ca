...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| Resource Providers | 1 | 0 | 0 | 0 | 1 | 0 |
| Nonprofit Organizations | 1775 | 1390 | 0 | 0 | 1 | 0 |
| IEP Advocates | 137 | 40 | 0 | 0 | 0 | 0 |

## Resource Providers

- public eligible rows: 0/1 (0%)
- stale rows: 0/1 (0%)
- stale among public eligible rows: 0/0 (0%)
- rows missing all freshness signals: 1/1 (100%)
- public eligible rows missing all freshness signals: 0/0 (0%)
...
- California: public stale 0/0 (0%), total stale 0/1

## Nonprofit Organizations

- public eligible rows: 1390/1775 (78.3%)
- stale rows: 0/1775 (0%)
- stale among public eligible rows: 0/1390 (0%)
- rows missing all freshness signals: 1/1775 (0.1%)
- public eligible rows missing all freshness signals: 0/1390 (0%)
...
- Georgia: public stale 0/159 (0%), total stale 0/488
- Illinois: public stale 0/309 (0%), total stale 0/316
- Ohio: public stale 0/265 (0%), total stale 0/271
...
- California: public stale 0/35 (0%), total stale 0/78

## IEP Advocates

- public eligible rows: 40/137 (29.2%)
- stale rows: 0/137 (0%)
- stale among public eligible rows: 0/40 (0%)
- rows missing all freshness signals: 0/137 (0%)
- public eligible rows missing all freshness signals: 0/40 (0%)
...
- Georgia: public stale 0/1 (0%), total stale 0/24
