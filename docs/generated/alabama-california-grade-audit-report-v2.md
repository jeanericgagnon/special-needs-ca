...
- protection_and_advocacy: missing_required_source_family :: Protection and advocacy has no strong California-grade evidence for Alabama.
- parent_training_information_center: legacy_or_inventory_only_evidence :: 7 inventory rows use DB-field agency labels; 49 inventory rows show federal/state mismatch; 8 generic roots need leaf verification
...
- protection_and_advocacy: missing; samples=3; first=http://adap.ua.edu/
- parent_training_information_center: inventory_only; samples=3; first=https://alabamaparentcenter.com
...
- Alabama remains UNSTARTED and not index-safe because one or more critical families are still legacy, inventory-only, or missing.
