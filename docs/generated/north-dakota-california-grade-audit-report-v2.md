# North Dakota California-Grade Batch 9 Report v1
...
- protection_and_advocacy: missing_required_source_family :: Protection and advocacy has no strong California-grade evidence for North Dakota.
...
- protection_and_advocacy: missing; samples=3; first=http://www.ndpanda.org/
- parent_training_information_center: inventory_only; samples=3; first=http://www.pathfinder-nd.org
...
- North Dakota remains UNSTARTED and not index-safe because one or more critical families are still legacy, inventory-only, or missing.
