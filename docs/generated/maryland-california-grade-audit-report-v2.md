# Maryland California-Grade Batch 12 Report v1
...
- parent_training_information_center: inventory_only; samples=3; first=https://ppmd.org
...
- Maryland remains UNSTARTED and not index-safe because one or more critical families are still legacy, inventory-only, or missing.
