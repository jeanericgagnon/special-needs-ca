# Missouri California-Grade Batch 4 Report v1
...
- protection_and_advocacy: missing_required_source_family :: Protection and advocacy has no strong California-grade evidence for Missouri.
...
- legal_aid: missing_required_source_family :: Legal aid has no strong California-grade evidence for Missouri.
...
- medicaid_waiver_hcbs_disability_services: verified_state_grade; samples=1; first=https://dmh.mo.gov/dev-disabilities/hcbs/eligibility
- developmental_disability_idd_authority: verified_state_grade; samples=1; first=https://dhhs.missouri.gov/dd
- early_intervention_part_c: verified_state_grade; samples=1; first=https://dhhs.missouri.gov/earlystart
- special_education_idea_part_b: verified_state_grade; samples=1; first=https://dese.mo.gov/
- district_or_county_education_routing: legacy_state_grade; samples=3; first=https://dese.mo.gov/
- vocational_rehabilitation_pre_ets: verified_state_grade; samples=1; first=https://dmh.mo.gov/dev-disabilities
- protection_and_advocacy: missing; samples=3; first=http://www.moadvocacy.org/
- parent_training_information_center: inventory_only; samples=3; first=https://ptimpact.org
...
- Missouri remains UNSTARTED and not index-safe because one or more critical families are still legacy, inventory-only, or missing.
