# Illinois California-Grade Audit Report v1

- Classification: `BLOCKED`
- Index safe: no
- Legacy status label: `KEEP_GATED (Pilot)`
- Strong critical families: 6/12
- Missing critical families: 3
- Weak/inventory-only critical families: 3
...
- Vocational rehabilitation / Pre-ETS: `missing` (no credible current evidence)
...
- vocational_rehabilitation_pre_ets: `missing_required_source_family` -> author_or_verify_statewide_source_family
