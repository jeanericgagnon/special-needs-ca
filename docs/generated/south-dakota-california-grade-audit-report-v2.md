# South Dakota California-Grade Batch 7 Report v1
...
- protection_and_advocacy: missing_required_source_family :: Protection and advocacy has no strong California-grade evidence for South Dakota.
...
- protection_and_advocacy: missing; samples=3; first=https://drsdlaw.org/
...
- South Dakota remains UNSTARTED and not index-safe because one or more critical families are still legacy, inventory-only, or missing.
