...
- Substantial layers: 4
- Partial layers: 4
- Thin layers: 0
- Demo-only layers: 1
- Modeled-only layers: 2
...
- Status: substantial
- Evidence: 3573 advocate listings
...
- Status: partial
- Evidence: 39 provider listings across 7/50 states
...
- Evidence: Those fields sit on 33111 directory rows total.
...
- Main gap: Core condition and need knowledge is populated, but some supporting reference tables are still empty in the checked-in DB.

## Knowledge articles and guidance content

- Status: partial
- Evidence: 15 knowledge articles
- Main gap: Knowledge content exists, but article volume is still small relative to the breadth of the rest of the information model.
