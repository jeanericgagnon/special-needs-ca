# New Jersey California-Grade Batch 17 Report v1
...
- parent_training_information_center: legacy_or_inventory_only_evidence :: 6 inventory rows use DB-field agency labels; 49 inventory rows show federal/state mismatch; 8 generic roots need leaf verification
...
- parent_training_information_center: inventory_only; samples=3; first=https://spanadvocacy.org/programs/p2p/
...
- New Jersey remains UNSTARTED and not index-safe because one or more critical families are still legacy, inventory-only, or missing.
