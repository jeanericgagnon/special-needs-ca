...
- protection_and_advocacy: blocked_reviewed_first_party_mn_disability_law_center_without_explicit_p_and_a_designation (Reviewed first-party Mid-Minnesota Legal Aid pages preserve a live Minnesota Disability Law Center route and phone line, but the saved artifact does not preserve explicit Protection and Advocacy designation text.)
...
- protection_and_advocacy: reviewed_first_party_mn_disability_law_center_route_lacks_explicit_protection_and_advocacy_designation :: The reviewed Mid-Minnesota Legal Aid site preserves a live Minnesota Disability Law Center route and phone line, but the saved first-party artifact does not preserve explicit Protection and Advocacy designation text.
- parent_training_information_center: reviewed_first_party_support_source_lacks_explicit_pti_designation :: Reviewed PACER Center evidence preserves Minnesota family-support language, special-education guidance, and direct advocate/help routing, but the saved first-party artifact does not preserve explicit PTI designation text.
...
- protection_and_advocacy: blocked_reviewed_first_party_mn_disability_law_center_without_explicit_p_and_a_designation; samples=1; first=https://mylegalaid.org/
...
- [major] protection_and_advocacy: hold_blocked_until_explicit_p_and_a_designation_is_preserved_from_reviewed_first_party_source
...
- Legal aid is now repaired through Mid-Minnesota Legal Aid.
- Protection and advocacy is narrowed to a reviewed first-party Minnesota Disability Law Center route, but explicit P&A designation is still unproven in the saved artifact.
- PTI remains blocked because bounded first-party PACER review still does not preserve explicit PTI designation text.
- Education routing remains blocked because the old MDE school-directory path now returns only a moved shell.
- County/local disability resources remain blocked because the likely official DHS county and tribal office pages redirect to a Radware Bot Manager challenge in bounded low-token mode.
