# Minnesota California-Grade Batch 5 Report v1
...
- legal_aid: missing_required_source_family :: Legal aid has no strong California-grade evidence for Minnesota.
...
- legal_aid: missing; samples=3; first=http://www.mndlc.org
...
- Minnesota remains UNSTARTED and not index-safe because one or more critical families are still legacy, inventory-only, or missing.
