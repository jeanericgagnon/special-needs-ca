# North Carolina California-Grade Batch 10 Report v1
...
- vocational_rehabilitation_pre_ets: verified_state_grade; samples=1; first=https://www.ncdhhs.gov/divisions/mhddsas
- protection_and_advocacy: missing; samples=0
- parent_training_information_center: inventory_only; samples=3; first=https://www.fsnhope.org/
...
- North Carolina remains UNSTARTED and not index-safe because one or more critical families are still legacy, inventory-only, or missing.
