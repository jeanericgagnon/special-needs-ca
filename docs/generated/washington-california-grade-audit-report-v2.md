# Washington California-Grade Batch 15 Report v1
...
- parent_training_information_center: legacy_or_inventory_only_evidence :: 4 inventory rows use DB-field agency labels; 49 inventory rows show federal/state mismatch; 32 generic roots need leaf verification
...
- Washington remains UNSTARTED and not index-safe because one or more critical families are still legacy, inventory-only, or missing.
