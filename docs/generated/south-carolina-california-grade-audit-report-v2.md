# South Carolina California-Grade Batch 10 Report v1
...
- protection_and_advocacy: missing_required_source_family :: Protection and advocacy has no strong California-grade evidence for South Carolina.
...
- legal_aid: missing_required_source_family :: Legal aid has no strong California-grade evidence for South Carolina.
...
- protection_and_advocacy: missing; samples=3; first=https://www.disabilityrightssc.org/
...
- South Carolina remains UNSTARTED and not index-safe because one or more critical families are still legacy, inventory-only, or missing.
