# Utah California-Grade Batch 12 Report v1
...
- protection_and_advocacy: missing_required_source_family :: Protection and advocacy has no strong California-grade evidence for Utah.
...
- legal_aid: missing_required_source_family :: Legal aid has no strong California-grade evidence for Utah.
...
- district_or_county_education_routing: legacy_state_grade; samples=3; first=https://schools.utah.gov/
...
- parent_training_information_center: inventory_only; samples=3; first=https://utahparentcenter.org
- legal_aid: missing; samples=3; first=http://disabilitylawcenter.org/
...
- Utah remains UNSTARTED and not index-safe because one or more critical families are still legacy, inventory-only, or missing.
