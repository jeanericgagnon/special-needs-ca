# Wyoming California-Grade Batch 14 Report v1
...
- protection_and_advocacy: missing_required_source_family :: Protection and advocacy has no strong California-grade evidence for Wyoming.
...
- parent_training_information_center: inventory_only; samples=3; first=https://wpic.org
...
- Wyoming remains UNSTARTED and not index-safe because one or more critical families are still legacy, inventory-only, or missing.
