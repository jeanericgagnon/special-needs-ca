...
- trusted provider rows: 10
- live provider hosts: calliercenter.utdallas.edu, bcm.edu, childrens.com, cookchildrens.org, dellchildrens.net, texaschildrens.org, depts.ttu.edu, uth.edu, utsouthwestern.edu
...
- texas-dallas-tx-callier-center-for-communication-disorders-rp: https://calliercenter.utdallas.edu/
  categories=providers_care | next_step=contact_provider | host=calliercenter.utdallas.edu
  hints=look for explicit languages, interpreter, ASL, telehealth, virtual visit, transportation, or accessibility wording on the first-party page ; check contact, patient-services, appointment, FAQ, and accessibility sections before considering deeper crawl expansion
