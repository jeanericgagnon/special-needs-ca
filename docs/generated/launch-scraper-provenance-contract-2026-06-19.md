...
Generated: 2026-06-19T23:21:10.770Z

Field-survival contract for launch scraper provenance so source-backed truth metadata survives fetch -> parse -> validate -> stage.

## Common Flow

- fetchStageFields: sourceUrl, finalUrl, stateId, gapFamily, targetTable, sourceQueue, sourceName, savedPath, contentType
- parsedStageFields: recordId, parserId, parsedAt, sourceUrl, finalUrl, stateId, gapFamily, targetTable, sourceQueue, sourceName, savedPath, contentType, canonicalUrl, pageTitle, metaDescription, textSample, familyExtraction, parseStatus
- validatedStageFields: validationStatus, validationReasons
- stagedCommonFields: source_url, source_name, source_type, scraped_at, state_id, county_id, confidence_score, extraction_notes, raw_text_excerpt, suggested_target_table, suggested_target_id, duplicate_candidate_id, review_status
