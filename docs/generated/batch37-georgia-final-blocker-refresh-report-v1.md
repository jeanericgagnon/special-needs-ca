...
- index_safe: false
- completeness_pct: 75
- education_leaf_count: 5
- dd_packet_root: dbhdd.georgia.gov
- remaining_failure_families: developmental_disability_idd_authority, district_or_county_education_routing, legal_aid
