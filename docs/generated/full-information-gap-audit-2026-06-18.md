...
- Queued in-scope families: 12
- Processed in-scope families: 0
- Explicitly blocked in-scope families: 3
- Unknown in-scope families: 0
- All in-scope families accounted for: yes
- Programs, waivers, appeals, and waitlists: queued (queue=261)
- Forms and guides: queued (queue=189)
- County offices and DD routing: queued (queue=282)
- Education routing: queued (queue=25)
- Nonprofits: queued (queue=824)
- Advocates and legal support: queued (queue=1980; blocker=advocate_directory_depth)
- Providers and care: queued (queue=128; blocker=provider_directory)
- Housing: queued (queue=2)
- Goods and supplies: queued (queue=1)
- Jobs and vocational support: queued (queue=1)
- Care and independent living: queued (queue=1)
