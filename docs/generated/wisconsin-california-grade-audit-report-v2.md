# Wisconsin California-Grade Batch 6 Report v1
...
- protection_and_advocacy: missing_required_source_family :: Protection and advocacy has no strong California-grade evidence for Wisconsin.
...
- protection_and_advocacy: missing; samples=3; first=http://www.disabilityrightswi.org
...
- Wisconsin remains UNSTARTED and not index-safe because one or more critical families are still legacy, inventory-only, or missing.
