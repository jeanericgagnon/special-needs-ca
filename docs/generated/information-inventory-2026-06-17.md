...
- Table `resource_providers`: 83 rows, 55 columns
- Table `nonprofit_organizations`: 29501 rows, 54 columns
- Table `iep_advocates`: 2995 rows, 59 columns
- Controlled values:
  - providerCategories: Autism, autism_clinic, card_center, Clinical, Developmental, developmental_clinic, developmental_pediatrics, diagnostic_center, Education, Hospital, Pediatrics, Speech, Therapy
...
- Notes:
  - Provider accessibility booleans with true signal: accepts_medi_cal 27/83; interpreter_available 22/83; asl_available 12/83; wheelchair_accessible 5/83; virtual_services 18/83; in_person_services 60/83; home_visits 3/83; transportation_help 8/83
