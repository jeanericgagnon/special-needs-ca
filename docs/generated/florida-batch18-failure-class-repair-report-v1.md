# Florida Batch 18 Failure-Class Repair Report v1

- classification: PARTIAL
- index_safe: false
- completeness_pct: 33
- repair_queue_count: 9
- primary_repair_lane: launch_gate_hold

## Repair queue

- [critical] launch_gate: lane=launch_gate_hold; next_action=keep_noindex_and_run_state_repair_lane; family_status=unknown
...
- [major] special_education_idea_part_b: lane=state_manifest_repair; next_action=author_verified_state_manifest; family_status=legacy_state_grade
...
- Florida remains PARTIAL and not index-safe. Batch 18 only converts packet evidence into repair lanes; it does not weaken the California-grade gate.
