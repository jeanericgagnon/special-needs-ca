...
| **Children's Nebraska** | M. Hospitals / university clinics / Hospitals | [childrensnebraska.org](https://www.childrensnebraska.org) | `static_fetch` | `resource_providers` |
| **Munroe-Meyer Institute** | M. Hospitals / university clinics / University clinics | [unmc.edu](https://www.unmc.edu/mmi) | `static_fetch` | `resource_providers` |
...
- **Source Name:** Children's Nebraska
- **Source URL:** [https://www.childrensnebraska.org](https://www.childrensnebraska.org)
- **Domain:** `childrensnebraska.org`
...
- **Terms Risk:** `low`
- **Priority:** 1
- **Notes:** Concrete first-party pediatric hospital target for Nebraska provider buildout.
- **Last Checked:** 2026-06-17

### Category: M. Hospitals / university clinics (University clinics)
- **Source Name:** Munroe-Meyer Institute
- **Source URL:** [https://www.unmc.edu/mmi](https://www.unmc.edu/mmi)
- **Domain:** `unmc.edu`
- **Target Table:** `resource_providers`
- **Expected Fields:** `name, phone, address`
- **Crawl Method:** `static_fetch`
...
- **Terms Risk:** `low`
- **Priority:** 2
- **Notes:** Concrete first-party university developmental disability clinic target for Nebraska.
- **Last Checked:** 2026-06-17
