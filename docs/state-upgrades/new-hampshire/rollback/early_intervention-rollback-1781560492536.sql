...
-- Generated At: 2026-06-15T21:54:52.550Z
...
UPDATE state_resource_agencies SET state_id = 'new-hampshire', agency_type = 'early_intervention', name = 'New Hampshire Early Intervention State Office', counties_served = 'statewide', catchment_boundaries = 'statewide', website = 'https://dhhs.new-hampshire.gov/earlystart', intake_phone = '', early_intervention_contact = '', agency_intake_contact = '', eligibility_info_page = '', services_page = '', appeals_info = '', frc_relationship = NULL, office_locations = NULL, languages = '', last_verified_date = '2026-06-14', source_urls = 'https://dhhs.new-hampshire.gov/earlystart', source_url = 'https://dhhs.new-hampshire.gov/earlystart', source_type = 'official_website', data_origin = 'scraped', verification_status = 'source_listed', last_scraped_at = NULL, confidence_score = 9.5, evidence_level = 'official_locator_derived' WHERE id = 'nh-ei-agency';
