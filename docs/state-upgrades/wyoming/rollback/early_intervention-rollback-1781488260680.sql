...
-- Generated At: 2026-06-15T01:51:00.693Z
...
UPDATE state_resource_agencies SET state_id = 'wyoming', agency_type = 'early_intervention', name = 'Wyoming Early Intervention and Education Program (EIEP)', counties_served = 'statewide', catchment_boundaries = 'statewide', website = 'https://health.wyo.gov/behavioralhealth/early-intervention-education-program-eiep/', intake_phone = '(307) 777-7148', early_intervention_contact = '', agency_intake_contact = '', eligibility_info_page = '', services_page = '', appeals_info = '', frc_relationship = NULL, office_locations = NULL, languages = '', last_verified_date = '2026-06-14', source_urls = 'https://health.wyo.gov/behavioralhealth/early-intervention-education-program-eiep/', source_url = 'https://health.wyo.gov/behavioralhealth/early-intervention-education-program-eiep/', source_type = 'official_website', data_origin = 'scraped', verification_status = 'source_listed', last_scraped_at = NULL, confidence_score = 9.9, evidence_level = 'official_locator_derived' WHERE id = 'wy-ei-agency';
