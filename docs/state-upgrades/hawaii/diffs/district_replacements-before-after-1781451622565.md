# Promotion Before/After Diff Report: Hawaii (district_replacements)
...
*   **Rows Updated:** 0
*   **Rows Deleted:** 3
*   **Primary Keys Re-keyed:** sd-kalawao-hi-fallback -> sd-kalawao-hi, sd-kauai-hi-fallback -> sd-kauai-hi, sd-maui-hi-fallback -> sd-maui-hi
