# Data Provenance Report: Rhode Island (RI)

This report details the data sources, records count, trust classifications, and launch readiness for the State of Rhode Island under the V3 release-quality standards as of June 2026.
...
- **Waiver Program Name**: `Rhode Island HCBS Waivers`
- **Personal Care Program**: `Rhode Island Medicaid Personal Care`
- **Developmental Disability (DD) Agency**: `Rhode Island Division of Developmental Disabilities`
- **State Education Agency**: `Rhode Island Department of Education`
- **State Education Agency SPED Label**: `Regional Special Education Agencies`
- **State Early Intervention Label**: `Rhode Island Early Intervention`
- **ABLE Savings Program**: `Rhode Island ABLE`
...
- **Rhode Island ABLE Program** (State Program): Source URL: https://www.ablenrc.org
  * Description: Tax-advantaged savings accounts for individuals with disabilities, protecting eligibility for public benefits.
- **Rhode Island Children's Health Insurance Program (CHIP)** (State Program): Source URL: https://eohhs.ri.gov
  * Description: Health insurance coverage for children in families whose income is too high to qualify for Medicaid.
- **Rhode Island Early Intervention Services** (State Program): Source URL: https://bhddh.ri.gov/developmental-disabilities
...
- **Rhode Island HCBS Waivers** (State Program): Source URL: https://bhddh.ri.gov/developmental-disabilities/hcbs/eligibility
  * Description: Home and community-based services waiver providing respite, habilitation, and family supports for Rhode Island residents...
- **Rhode Island Medicaid** (State Program): Source URL: https://eohhs.ri.gov
...
- **Rhode Island Medicaid Personal Care** (State Program): Source URL: https://eohhs.ri.gov
  * Description: In-home personal care services assisting with daily living activities under the state Medicaid plan.
- **Rhode Island Self-Direction Services** (State Program): Source URL: https://bhddh.ri.gov/developmental-disabilities
...
- **Rhode Island Special Education IEP** (State Program): Source URL: https://www.ed.gov
...
- **Rhode Island Transition & Vocational Rehabilitation** (State Program): Source URL: https://bhddh.ri.gov/developmental-disabilities
...
- **SSI for Children (Rhode Island)** (State Program): Source URL: https://www.ssa.gov
...
- **Rhode Island Developmental Services Intake** (dd_intake): Website: https://dhhs.rhode-island.gov/dd | Phone: None | Status: `manual_review_required`
- **Rhode Island Early Intervention State Office** (early_intervention): Website: https://dhhs.rhode-island.gov/earlystart | Phone: None | Status: `manual_review_required`
...
| Kent County | 1 | 1 | 3 | 4 | 🟢 COMPLETE |
| Newport County | 1 | 1 | 3 | 2 | 🟢 COMPLETE |
| Providence County | 1 | 1 | 3 | 4 | 🟢 COMPLETE |
...
| :--- | :--- | :--- | :--- |
| Office | Bristol County storefront office | Bristol County | `off-bristol-ri-medicaid` |
| Office | Kent County storefront office | Kent County | `off-kent-ri-medicaid` |
| Office | Newport County storefront office | Newport County | `off-newport-ri-medicaid` |
| Office | Providence County storefront office | Providence County | `off-providence-ri-medicaid` |
| Office | Washington County storefront office | Washington County | `off-washington-ri-medicaid` |
| School District | Kent Public Schools Special Education | Kent County | `sd-kent-ri` |
| School District | Providence Public Schools Special Education | Providence County | `sd-providence-ri` |
| School District | Bristol County School District | Bristol County | `sd-bristol-ri` |
| School District | Newport County School District | Newport County | `sd-newport-ri` |
| School District | Washington County School District | Washington County | `sd-washington-ri` |
| Nonprofit | The Arc of Rhode Island | Bristol County | `ri-np-arc-bristol-ri` |
| Nonprofit | The Arc of Rhode Island | Kent County | `ri-np-arc-kent-ri` |
| Nonprofit | The Arc of Rhode Island | Newport County | `ri-np-arc-newport-ri` |
| Nonprofit | The Arc of Rhode Island | Providence County | `ri-np-arc-providence-ri` |
| Nonprofit | The Arc of Rhode Island | Washington County | `ri-np-arc-washington-ri` |
