# Scraping Upgrade Proposal: Vermont (VT)

This upgrade proposal maps out the transition from seeded/programmatic fallback records to live, scraper-derived official data for Vermont.
...
- Replaces programmatic office: `vermont-medicaid-office-addison-county`
- Replaces programmatic district: `vermont-school-district-addison-county-fallback`
