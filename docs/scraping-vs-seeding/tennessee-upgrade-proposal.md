# Scraping Upgrade Proposal: Tennessee (TN)

This upgrade proposal maps out the transition from seeded/programmatic fallback records to live, scraper-derived official data for Tennessee.
...
- Replaces programmatic office: `tennessee-medicaid-office-anderson-county`
- Replaces programmatic district: `tennessee-school-district-anderson-county-fallback`
