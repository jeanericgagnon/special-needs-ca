# Scraping Upgrade Proposal: Ohio (OH)

This upgrade proposal maps out the transition from seeded/programmatic fallback records to live, scraper-derived official data for Ohio.
...
- Replaces programmatic office: `ohio-medicaid-office-adams-county`
- Replaces programmatic district: `ohio-school-district-adams-county-fallback`
