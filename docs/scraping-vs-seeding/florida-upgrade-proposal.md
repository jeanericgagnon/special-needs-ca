# Scraping Upgrade Proposal: Florida (FL)

This upgrade proposal maps out the transition from seeded/programmatic fallback records to live, scraper-derived official data for Florida.
...
- Replaces programmatic office: `florida-medicaid-office-alachua-county`
- Replaces programmatic district: `florida-school-district-alachua-county-fallback`
