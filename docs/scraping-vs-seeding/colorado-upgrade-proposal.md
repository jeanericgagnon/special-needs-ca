# Scraping Upgrade Proposal: Colorado (CO)

This upgrade proposal maps out the transition from seeded/programmatic fallback records to live, scraper-derived official data for Colorado.
...
- Replaces programmatic office: `colorado-medicaid-office-adams-county`
- Replaces programmatic district: `colorado-school-district-adams-county-fallback`
