# Scraping Upgrade Proposal: Hawaii (HI)

This upgrade proposal maps out the transition from seeded/programmatic fallback records to live, scraper-derived official data for Hawaii.
...
- Replaces programmatic office: `hawaii-medicaid-office-hawai'i-county`
- Replaces programmatic district: `hawaii-school-district-hawai'i-county-fallback`
