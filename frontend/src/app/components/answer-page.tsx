        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
          ...
          <div>
            ...
            <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap', fontSize: '0.82rem', color: 'var(--text-light)', borderBottom: '1px solid rgba(0,0,0,0.06)', paddingBottom: '1rem' }}>
              {data.officialSources && data.officialSources.length > 0 ? (
                <span>Verified Source: <strong style={{ color: 'var(--text-main)' }}>{data.officialSources[0].name}</strong></span>
              ) : (
                <span>Source: <strong style={{ color: 'var(--text-main)' }}>Verification pending</strong></span>
              )}
